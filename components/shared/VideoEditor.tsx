    ...
    <div className="container mx-auto max-w-screen-lg pt-3">
      <main className="mx-auto">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="relative mt-2 w-full lg:w-3/4 border rounded-lg flex items-center justify-center bg-secondary overflow-hidden">
            {video && (
              <video
                ref={videoRef}
                src={video}
        ...
        {video && (
          <div className="flex flex-col lg:flex-row gap-8 mt-8">
            <div className="w-full lg:w-1/4 space-y-8 p-2 overflow-y-auto h-full">
